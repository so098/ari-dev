...
1년 4개월이 지난 지금 돌아보면, 그때 나는 정말 아무것도 몰랐다.
...
혼자 다 했다고 하면 거짓말이다. 근데 모르는 건 물어보고, 내가 해야 할 건 했다. 그게 협업이니까.
...
기능은 계속 추가되는데, 디자이너들이 뭐가 바뀌었는지를 몰랐다. 당연히 안 쓰지. 뭐가 있는지도 모르는데 말이다.

그래서 선임 디자이너한테 먼저 찾아갔다. 슬랙으로도 얘기하고, 직접 만나서도 물어봤다. "지금 이 서비스 어때요? 뭐가 불편해요?"

그러다가 회사 내 일본 디자이너 쪽에서도 이 서비스를 쓰고싶다는 얘기를 들었다. 그래서 제안했다. 정기적으로 구글 밋 하자고.
...
지금 다시 하라고 하면 다르게 할 것 같다. 그게 성장이라고 생각한다.
...
다음에는 어떤 서비스를 만들게 될지 모르겠다. 근데 한 가지는 확실하다. 사용자한테 도움이 되는지를 계속 파악하는 건 계속할 것 같다. 그게 제일 중요했으니까.
