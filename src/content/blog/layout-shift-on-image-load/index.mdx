---
title: '"이 웹페이지는 이미지가 늦게 뜨네 나가야겠다"를 막기 위한 Skeleton UI 적용기'
description: '이미지 리스트를 동적으로 불러올 때 발생하는 레이아웃 시프트(CLS)의 원인을 브라우저 Reflow 관점에서 분석하고, Skeleton UI와 Progressive Image Loading 등 세 가지 해결 전략을 비교 적용한 결과를 공유합니다.'
date: '2025-01-24'
...
## 이미지 로딩이 UI에 미치는 영향
<img src="/blog/layout-shift/image-road-default.gif" alt="로딩 데모" width="400" />
...
<img src="/blog/layout-shift/load-all-at-once-image.gif" alt="전체 이미지 한번에 로드 데모" width="400" />
...
<img src="/blog/layout-shift/differently-each-image-load.gif" alt="전체 이미지 한번에 로드 데모" width="400" />
...
<img src="/blog/layout-shift/blur-next-image.gif" alt="블러 이미지 데모" width="400" />
...
<div class="flex gap-4 my-4 max-sm:flex-col">
  <div class="border rounded-xl px-3 py-5">
    ...
    <img src="/blog/layout-shift/image-road-default.gif" alt="로딩 데모" width="320" class="mx-auto"/>
    <img src="/blog/layout-shift/cls-image-road-default.png" alt="기본 로드 cls" className=' mb-0' width="100%" height="200px"/>
  ...
  <div class="border rounded-xl px-3 py-5">
    ...
    <img src="/blog/layout-shift/differently-each-image-load.gif" alt="전체 이미지 한번에 로드 데모" width="320" class="mx-auto" />
    <img src="/blog/layout-shift/cls-after-image-road.png" alt="개선 로드 cls" className='  mb-0' width="100%" />
	<p class="text-center text-[0.7rem] text-gray-400 mb-3 mt-0">Cumulative Layout Shift (CLS) 점수</p>
    <div  class="text-[0.8rem]">
